...
//       appBar: AppBar(
//         backgroundColor: const Color(0xFF366000),
//         elevation: 0,
//         title: const Text("Yucca Consulting Ltd"),
//         actions: [
//           IconButton(
...
//             const Text("Smart agricultural solutions for you"),
...
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: const [
//                       Text("Today's Weather", style: TextStyle(fontWeight: FontWeight.bold)),
//                       SizedBox(height: 4),
...
//               mainAxisSpacing: 12,
//               children: [
//                 feature(Icons.camera_alt, "Soil Scan"),
//                 feature(Icons.eco, "Crop Advice"),
//                 feature(Icons.bar_chart, "Reports"),
//                 feature(Icons.lightbulb, "Tips"),
//               ],
//             ),
...
//                 label: const Text("Scan Soil Now"),
...
//   Widget feature(IconData icon, String title) {
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,
//         borderRadius: BorderRadius.circular(16),
...
//           children: [
//             Icon(icon, size: 40, color: const Color(0xFF366000)),
...
//       {'icon': Icons.camera_alt, 'title': 'Soil Scan', 'login': true},
//       {'icon': Icons.eco, 'title': 'Crop Advice', 'login': true},
//       {'icon': Icons.bar_chart, 'title': 'Reports', 'login': true},
//       {'icon': Icons.lightbulb, 'title': 'Tips', 'login': false},
//     ];
...
//       mainAxisSpacing: 12,
//       children: features
//           .map((f) => _featureItem(f['icon'] as IconData, f['title'] as String,
...
//       width: double.infinity,
//       child: ElevatedButton.icon(
//         onPressed: () => _handleFeature("Scan Soil Now", requiresLogin: true),
//         icon: const Icon(Icons.camera_alt),
//         label: const Text("Scan Soil Now"),
//         style: ElevatedButton.styleFrom(
//           backgroundColor: primaryGreen,
